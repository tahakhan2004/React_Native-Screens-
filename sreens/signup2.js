...
import wel from "../Asstes/wel2.png"
...
function Signup2(){
  ...
  <View style={{width:"100%", padding:10, marginTop:0}}>
    ...
    <Image source={wel} style={{width:220, height:110}}/>
    </View>
    {/* <Text style={styles.mainheading}>LogIn</Text> */}
    <View style={{alignItems:'center', padding:8, marginTop: 15  }}>
    <TextInput placeholder="UserName" onChangeText={(e)=>setname(e)} style={styles.inp} placeholderTextColor={'white'}/>
  </View>
  <View style={{alignItems:'center', padding:8, marginTop: 0  }}>
    <TextInput placeholder="Contact no" keyboardType="numeric" onChangeText={(e)=>setnumber(e)} style={styles.inp} placeholderTextColor={'white'}/>
  </View>
  <View style={{alignItems:'center', padding:8, marginTop: 0  }}>
